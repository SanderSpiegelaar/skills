...
- Should trigger for: create AGENTS.md, update AGENTS.md, maintain agent docs, set up CLAUDE.md, document repo agent conventions, reduce agent instruction prose, bootstrap agent docs for an empty repo or greenfield scaffold.
...
- Greenfield and low-signal repos depend on timely user answers during elicitation; without them, output stays minimal or pending by design.
