...
description: After to-feature-prd, produce a high-level IMPLEMENTATION.md next to docs/{nn}-{feature-slug}/PRD.md for ticket breakdown with to-tickets. Use when the user wants an implementation bridge doc, slice-scoped technical sequencing, or handoff from slice PRD to issues.
---
...
- **Input:** `docs/{nn}-{feature-slug}/PRD.md`.
- **Do:** Map the slice PRD into vertical implementation increments.
- **Output:** `docs/{nn}-{feature-slug}/IMPLEMENTATION.md`.
- **Next:** Run **to-tickets**.
...
6. **Write the file.** Persist `docs/{nn}-{feature-slug}/IMPLEMENTATION.md` next to `PRD.md`.
...
- [`references/example-implementation.md`](references/example-implementation.md) — golden implementation outline example.
