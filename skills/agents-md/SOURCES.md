...
6. Elicit before drafting when the repo is low-signal (empty, scaffold, README-only, or pre-tooling); use Cursor `AskQuestion` for discrete choices; never fabricate commands or paths.
   Status: adopted
